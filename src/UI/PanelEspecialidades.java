...
public class PanelEspecialidades extends JPanel {
    ...
    private CampoTexto nombreField, identificadorField;

    private boolean estado;

    private Boton btnCrearEspecialidad, btnActualizar, btnCancelar;
    ...
    public PanelEspecialidades(AdminView adminView) {
        ...
        JLabel moduleTitle = new JLabel("Módulo Especialidades");
        ...
        // nombre especialidad
        JLabel nombreLabel = new JLabel("Nombre Especialidad");
        gbc.gridx = 0;
        medicoForm.add(nombreLabel, gbc);
       ...
       // Segundo Nombre
        ...
        nombreField = new CampoTexto(20);
        gbc.gridx = 0;
        medicoForm.add(nombreField, gbc);
      ...
      // ID especialidad
        ...
        gbc.gridx = 0;
        gbc.gridy = 3;
        medicoForm.add(identificadorLabel, gbc);
        ...
        identificadorField = new CampoTexto(20);
        gbc.gridx = 0;
        medicoForm.add(identificadorField, gbc);
       ...
       /*   JLabel telefonoLabel = new JLabel("Telefono");
        ...
        // Boton Crear Medico
        btnCrearEspecialidad = new Boton("Crear Especialidad");
        gbc.gridx = 0;
        gbc.gridy = 11;
        gbc.anchor = GridBagConstraints.CENTER;
        gbc.fill = GridBagConstraints.NONE;
        ...
        gbc.weighty = 1.0;
        gbc.gridwidth = 2;
        medicoForm.add(btnCrearEspecialidad, gbc);
        ...
        JPanel tablaEspecialidadesPanel = new JPanel(new GridBagLayout());
        tablaEspecialidadesPanel.setBorder(new EmptyBorder(new Insets(0, 0, 20, 20)));
        ...
        modeloTabla = new DefaultTableModel(new Object[]{"Especialidad", "ID", "Estado"}, 0);
        ...
        tablaEspecialidadesPanel.add(scrollTabla, gbcInterno);
        ...
        add(tablaEspecialidadesPanel, BorderLayout.CENTER);
        ...
        btnCrearEspecialidad.addActionListener(e->{
            ...
            try {
                boolean valid = servicioEspecialidad.crearEspecialidad(datos);
                if (valid) {
                    actualizarTabla();
        ...
        btnCancelar.addActionListener(e->{
            ...
            btnActualizar.setVisible(false);
            btnCancelar.setVisible(false);
            btnCrearEspecialidad.setVisible(true);
        });

        tablaEspecialidades.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent e) {
                filaSeleccionada = tablaEspecialidades.rowAtPoint(e.getPoint());
            }
        });
/*
        itemEditar.addActionListener(_->{
            UtilidadesForm.limpiarCampos(medicoForm);
            cargarMedico();
            btnCrearEspecialidad.setVisible(false);
