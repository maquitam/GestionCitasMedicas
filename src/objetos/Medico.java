...
public class Medico extends Usuario {
    ...
    public Medico(int id,
            ...
            String numeroDocumento, String especialidad, String correo, String telefono, String direccion,
            String perfil, boolean estado, String contrasenna) {
    ...
    public String toTxtFormat() {
        return getId() + "|" + getNombres() + "|" + getApellidos() + "|" + getTipoDocumento() + "|" + getNumeroDoc()
                + "|" + getEspeciliadad() + "|" +
                getCorreo() + "|" + getTelefono() + "|" + getDireccion() + "|" + getPerfil() + "|" + getEstado() + "|"
                + getContrassena();
    }
    ...
    public static Medico fromTxtFormat(String lineaMedico) {
        ...
        Medico medico = new Medico(Integer.parseInt(parts[0]), parts[1], parts[2], (parts[3]), (parts[4]), parts[5],
                parts[6], (parts[7]), (parts[8]), (parts[9]), Boolean.parseBoolean(parts[10]), (parts[11]));
        return medico;
    }
}
