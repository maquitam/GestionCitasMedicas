...
public class Paciente extends Usuario {
    ...
    public Paciente(int id, String nombres, String apellidos, String tipoDocumento, String numeroDocumento,
            String fechaDeNacimiento,
            String sexo, String grupoSanguineo, String correo, String telefono, String direccion, String perfil,
            String contrasenna) {
    ...
    public String toTxtFormat() {
        return getId() + "|" + getNombres() + "|" + getApellidos() + "|" + getTipoDocumento() + "|" + getNumeroDoc()
                + "|" + getFechadeNacimiento() + "|" +
                getSexo() + "|" + getGrupo() + getRh() + "|" + getCorreo() + "|" + getTelefono() + "|" + getDireccion()
                + "|" + getPerfil() + "|" + getContrassena();
    }
    ...
    public static Paciente fromTxtFormat(String lineaPaciente) {
        ...
        Paciente paciente = new Paciente(Integer.parseInt(parts[0]), parts[1], parts[2], (parts[3]), (parts[4]),
